...
const ContactUs = () => {
  return (
    <div className="relative">
      ...
      <div className="relative z-10 bg-white/90 text-gray-800 px-6 py-20">
          ...
          <div className="max-w-6xl w-full mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col">
                ...
                <div className="w-full h-1 bg-amber-500 rounded-full mb-6"></div>
                <p className="text-gray-700 mb-8 leading-relaxed">
                  Do you have questions, requests, or suggestions? We look
                  forward to your call and will be pleased to assist you .
                  Please fill out the form by specifying your concern alongside
                ...
                <form className="space-y-6">
                  ...
                  <div className="flex justify-start items-center pt-4">
                    <button
                      type="submit"
                      className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-full shadow-sm text-gray-600 bg-transparent hover:bg-gray-100 transition duration-300 ease-in-out"
                    >
              ...
              <div className="flex flex-col">
                ...
                <div className="bg-[#005f7f] text-white p-6 rounded-lg shadow-md mb-8">
                  <p className="mb-3 flex gap-2">
                    <strong className="block text-sm mb-1">Address:</strong>
                    A3085, Building 1, No.888, Dongchang Road, Jiangbei
                    District, Ningbo, China.
                  </p>
                  <p className="mb-3 flex gap-2">
                    <strong className="block text-sm mb-1">Email:</strong>
                    <a
                      href="mailto:info@nbxifa.com"
                ...
                {/* Orange underline, adjusted width to match image more closely */}
                <div className="w-[70%] h-1 bg-amber-500 rounded-full mb-6"></div>
                ...
                <div className="text-gray-700">
                  ...
                  <p className="mb-2">
                    <strong className="w-32 inline-block">Saturday:</strong> 10
                    AM - 2 PM
                  </p>
                  <p>
                    <strong className="w-32 inline-block">Sunday:</strong>{" "}
                    Closed
                  </p>
                </div>
              </div>
