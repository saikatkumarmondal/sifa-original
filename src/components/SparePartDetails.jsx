...
const SparePartDetails = () => {
  ...
  return (
    ...
    <div>
      <div className="relative w-screen h-64 flex justify-center items-center my-5 overflow-hidden">
        {/* Background Image */}
        <img
          src={SparePartsLogo}
          alt="Spare Parts"
        ...
        {/* Centered Animated Text with blackish colors */}
        <motion.h1
      ...
      <div className="max-w-7xl mt-3 mx-auto p-8 grid grid-cols-12 gap-10 text-black bg-white rounded-xl shadow-2xl ring-4 ring-yellow-500/80">
          ...
          <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
            <p>
              ...
              <span className="ml-2 text-gray-700">
                ...
                original SlFA packaging to guarantee quality and authenticity.
              </span>
            </p>
          </div>
          ...
          <ul className="list-none space-y-3 pl-0">
            ...
            <li className="flex items-start text-lg">
              ...
              <p>
                ...
                &nbsp;
                <span>
                  Each unit is tested to ensure smooth and flawless
                  functionality.
                </span>
              </p>
            </li>
            ...
            <li className="flex items-start text-lg">
              ...
              <p>
                ...
                &nbsp;
                <span>
                  Packed securely in sturdy export-quality boxes to prevent
